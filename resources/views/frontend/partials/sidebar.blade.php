    ...
    <div class="sidebar-wrap bg-light ftco-animate">
        ...
        <form action="#">
            <div class="fields">
                ...
                <div class="form-group">
                    <input type="text" id="checkin_date" class="form-control checkin_date" placeholder="Nhận phòng">
                </div>
                <div class="form-group">
                    <input type="text" id="checkin_date" class="form-control checkout_date" placeholder="Trả phòng">
                </div>
                <div class="form-group">
